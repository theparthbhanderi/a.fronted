    ...
    <div style={{ display: 'flex', padding: '4px 12px 0 6px', flex: 1 }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', paddingLeft: 14, paddingTop: 2 }}>
        ...
        <div style={{
          ...
          {/* Gujarati disclaimer */}
          <div style={{ fontSize: 8.5, color: '#000', lineHeight: 1.3, fontFamily: 'Arial, sans-serif' }}>
          ...
          {/* English disclaimer */}
          <div style={{ fontSize: 8.5, color: '#000', lineHeight: 1.3, marginTop: 1, fontFamily: 'Arial, sans-serif' }}>
